...
--
-- Host: localhost:3306
-- Generation Time: Nov 25, 2023 at 11:06 PM
...
('debian-sys-maint', '[{\"db\":\"tic4301\",\"table\":\"form\"},{\"db\":\"tic4301\",\"table\":\"users\"}]');
...
('debian-sys-maint', 'tic4301', 'users', '{\"sorted_col\":\"`users`.`user_id` ASC\"}', '2023-11-23 05:58:40');
...
('debian-sys-maint', '2023-11-26 05:05:44', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}'),
('phpmyadmin', '2023-11-21 11:52:32', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `tic4301`
--
CREATE DATABASE IF NOT EXISTS `tic4301` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `tic4301`;
